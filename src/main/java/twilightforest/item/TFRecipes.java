...
public class TFRecipes {
    ...
    public static void registerRecipes() {
        ...
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 0), "w", 'w', new ItemStack(TFBlocks.log, 1, 0));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 1), "w", 'w', new ItemStack(TFBlocks.log, 1, 1));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 2), "w", 'w', new ItemStack(TFBlocks.log, 1, 2));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 3), "w", 'w', new ItemStack(TFBlocks.log, 1, 3));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 4), "w", 'w', new ItemStack(TFBlocks.magicLog, 1, 0));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 5), "w", 'w', new ItemStack(TFBlocks.magicLog, 1, 1));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 6), "w", 'w', new ItemStack(TFBlocks.magicLog, 1, 2));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.plank, 4, 7), "w", 'w', new ItemStack(TFBlocks.magicLog, 1, 3));
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(TFBlocks.fireflyJar, 1, 0), TFBlocks.firefly, Items.glass_bottle);
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(TFItems.magicMapFocus), TFItems.feather, TFItems.torchberries, Items.glowstone_dust);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.emptyMagicMap), "###", "#X#", "###", '#', Items.paper, 'X', TFItems.magicMapFocus);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.emptyMazeMap), "###", "#X#", "###", '#', Items.paper, 'X', TFItems.mazeMapFocus);
        GameRegistry.addShapelessRecipe(
        ...
        GameRegistry.addRecipe(
                new ItemStack(Items.arrow, 4), "X", "#", "Y", 'Y', TFItems.feather, 'X', Items.flint, '#', Items.stick);

        GameRegistry.addShapelessRecipe(
                new ItemStack(Items.stick), new ItemStack(TFBlocks.plant, 1, BlockTFPlant.META_ROOT_STRAND));
        GameRegistry.addRecipe(
                new ItemStack(Blocks.torch, 5), "B", "S", 'B', TFItems.torchberries, 'S', Items.stick);

        GameRegistry.addShapelessRecipe(
                new ItemStack(TFItems.ironwoodRaw), TFItems.liveRoot, Items.iron_ingot, Items.gold_nugget);
        ...
        addEnchantedRecipe(
                ...
                1, "#", "#", "X", '#', TFItems.ironwoodIngot, 'X', Items.stick);
        addEnchantedRecipe(
                TFItems.ironwoodShovel,
                Enchantment.unbreaking,
                1, "#", "X", "X", '#', TFItems.ironwoodIngot, 'X', Items.stick);
        addEnchantedRecipe(
        ...
        addEnchantedRecipe(
                TFItems.ironwoodHoe,
                null,
                0, "##", " X", " X", '#', TFItems.ironwoodIngot, 'X', Items.stick);
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(TFItems.fieryIngot), TFItems.fieryBlood, Items.iron_ingot);
        GameRegistry.addShapelessRecipe(
                new ItemStack(TFItems.fieryIngot), TFItems.fieryTears, Items.iron_ingot);
        GameRegistry
                .addRecipe(new ItemStack(TFItems.fieryHelm), "###", "# #", '#', TFItems.fieryIngot);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.fieryPlate), "# #", "###", "###", '#', TFItems.fieryIngot);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.fieryLegs), "###", "# #", "# #", '#', TFItems.fieryIngot);
        GameRegistry
                .addRecipe(new ItemStack(TFItems.fieryBoots), "# #", "# #", '#', TFItems.fieryIngot);
        addEnchantedRecipe(
                TFItems.fierySword,
                Enchantment.fireAspect,
                2, "#", "#", "X", '#', TFItems.fieryIngot, 'X', Items.blaze_rod);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.fieryPick), "###", " X ", " X ", '#', TFItems.fieryIngot, 'X', Items.blaze_rod);

        addEnchantedRecipe(
                TFItems.steeleafHelm,
                Enchantment.projectileProtection,
                2, "###", "# #", '#', TFItems.steeleafIngot);
        addEnchantedRecipe(
        ...
        addEnchantedRecipe(
                ...
                Enchantment.looting,
                2, "#", "#", "X", '#', TFItems.steeleafIngot, 'X', Items.stick);
        addEnchantedRecipe(
                TFItems.steeleafShovel,
                Enchantment.efficiency,
                2, "#", "X", "X", '#', TFItems.steeleafIngot, 'X', Items.stick);
        addEnchantedRecipe(
        ...
        addEnchantedRecipe(
                TFItems.steeleafHoe,
                null,
                0, "##", " X", " X", '#', TFItems.steeleafIngot, 'X', Items.stick);
        ...
        // dark tower recipes
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.towerWood, 4, 0), "##", "##", '#', new ItemStack(TFBlocks.log, 1, 3));
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.towerWood, 3, 1), "#", "#", "#", '#', new ItemStack(TFBlocks.towerWood, 1, 0));
        GameRegistry.addRecipe(
        ...
        GameRegistry.addRecipe(
                new ItemStack(TFItems.shardCluster), "###", "###", "###", '#', TFItems.armorShard);

        GameRegistry.addSmelting(TFItems.shardCluster, new ItemStack(TFItems.knightMetal), 1.0F);

        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlyHelm), "###", "# #", '#', TFItems.knightMetal);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlyPlate), "# #", "###", "###", '#', TFItems.knightMetal);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlyLegs), "###", "# #", "# #", '#', TFItems.knightMetal);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlyBoots), "# #", "# #", '#', TFItems.knightMetal);

        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlySword), "#", "#", "X", '#', TFItems.knightMetal, 'X', Items.stick);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlyPick), "###", " X ", " X ", '#', TFItems.knightMetal, 'X', Items.stick);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlyAxe), "##", "#X", " X", '#', TFItems.knightMetal, 'X', Items.stick);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightlyAxe), "##", "X#", "X ", '#', TFItems.knightMetal, 'X', Items.stick);
        ...
        GameRegistry
                .addRecipe(new ItemStack(TFItems.arcticHelm), "###", "# #", '#', TFItems.arcticFur);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.arcticPlate), "# #", "###", "###", '#', TFItems.arcticFur);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.arcticLegs), "###", "# #", "# #", '#', TFItems.arcticFur);
        GameRegistry
                .addRecipe(new ItemStack(TFItems.arcticBoots), "# #", "# #", '#', TFItems.arcticFur);

        GameRegistry
                .addRecipe(new ItemStack(TFBlocks.auroraSlab, 6, 0), "###", '#', TFBlocks.auroraBlock);
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.auroraPillar, 2, 0), "#", "#", '#', TFBlocks.auroraBlock);
        ...
        GameRegistry.addRecipe(
                ...
                TFBlocks.giantLog);
        GameRegistry.addRecipe(
                new ItemStack(TFItems.giantSword), "#", "#", "X", '#', TFBlocks.giantCobble, 'X', TFBlocks.giantLog);

        GameRegistry.addShapelessRecipe(
                new ItemStack(Blocks.cobblestone, 64), new ItemStack(TFBlocks.giantCobble));
        GameRegistry.addShapelessRecipe(
                new ItemStack(Blocks.planks, 64), new ItemStack(TFBlocks.giantLog));
        GameRegistry.addShapelessRecipe(
                new ItemStack(Blocks.leaves, 64), new ItemStack(TFBlocks.giantLeaves));

        GameRegistry.addRecipe(
                new ItemStack(TFItems.knightmetalRing), " # ", "# #", " # ", '#', TFItems.knightMetal);
        GameRegistry.addShapelessRecipe(
        ...
        GameRegistry.addRecipe(
                new ItemStack(TFBlocks.knightmetalStorage), "###", "###", "###", '#', TFItems.knightMetal);
